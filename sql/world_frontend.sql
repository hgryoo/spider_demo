...
(host '10.10.10.11', database 'world', user 'dba', password 'demo_password', port 3306);

CREATE server IF NOT EXISTS backend2 foreign data wrapper mysql options
(host '10.10.10.12', database 'world', user 'dba', password 'demo_password', port 3306);

CREATE server IF NOT EXISTS backend3 foreign data wrapper mysql options
(host '10.10.10.13', database 'world', user 'dba', password 'demo_password', port 3306);
...
) ENGINE=SPIDER AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='wrapper "mysql", srv "backend1"';
...
CREATE TABLE `country` (
  ...
  PRIMARY KEY (`Code`)
) ENGINE=SPIDER DEFAULT CHARSET=utf8 COMMENT='wrapper "mysql", srv "backend2"';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=SPIDER DEFAULT CHARSET=utf8 COMMENT='wrapper "mysql", srv "backend3"';;
/*!40101 SET character_set_client = @saved_cs_client */;
