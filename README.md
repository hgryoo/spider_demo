...
#### Description
After completing the following setup, you may access the spider database via the mysql commandline client on node1 and view the "world" schema.  You may also connect via your favorite GUI directly from your host machine by connecting to IP: **10.10.10.10** with username: **dba** and password: **demo_password**. Tables are stored on separate backend servers to demonstrate horizontal sharding.
